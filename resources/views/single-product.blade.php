...
@section('content')
  <div class="py-8 lg:py-12">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
      ...
      <div>
        <h1 class="font-montserrat text-4xl font-bold lowercase text-fashl-black mb-2" id="pdp-product-title">the midi wrap dress</h1>
        <p class="font-inter text-2xl font-semibold text-fashl-black mb-6" id="pdp-product-price">£42.00</p>
        ...
        <div class="flex items-center space-x-4 mb-6">
          ...
          <button 
            ...
            data-product-id="pdp-midi-wrap-dress"
            data-product-title="the midi wrap dress"
            data-product-price="42.00"
            data-product-image="https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=100&h=120&fit=crop&auto=format&q=80"
          >
            add to cart
          </button>
        </div>
